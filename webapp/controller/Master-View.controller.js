sap.ui.define([
    ...
    function (Controller, MessageToast, MessageBox, Sorter, Filter, FilterOperator, FilterType,
        ...
        return Controller.extend("constants.model.routes.Fragments.Dialog", {
            onInit: function () {
            },
            ...
            onDelete: function () {
                ...
                if (oSelected) {
                    ...
                    oContext.delete().then(function () {
                        MessageToast.show(this._getText("Deletion Success", sUserName));
                        ...
                        this._setUIChanges();
                        if (oError.canceled) {
                            MessageToast.show(this._getText("Deletion Restored", sUserName));
                            return;
                        }
            ...
            onRefresh: function () {
                ...
                oBinding.refresh();
                MessageToast.show(this._getText("Refresh Success"));
            },
            ...
            onSort: function () {
                ...
                oView.byId("peopleList").getBinding("items").sort(sOrder && new Sorter("ProductName",
                    sOrder === "desc"));
            ...
            onInfoMessageBoxPress: function () {
                MessageBox.information("The product will be retain in less than 24HS.");
            },
            formatter: formatter,
        });
    });
